...
class DBATran extends React.Component {
    constructor(){
        super()
        this.state={
            id:0,
    ...
    onClicked() {
     ...
     showTran(){
        ...
        fetch ('http://localhost:8080/api/Me/DBACheckingAccount', {
            headers: 
                {
        ...
        .then(data=>{
                ...
                document.querySelector('#dba').insertAdjacentHTML('afterbegin', transactionCard )
        })
        .catch((error) => {
            console.log(error);
        }
